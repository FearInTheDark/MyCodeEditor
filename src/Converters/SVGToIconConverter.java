...
//        System.out.println(file.exists() ? "File exists" : "File not found");
        ...
        File file = new File("C:\\Users\\Vinh.Lap\\.vscode\\extensions\\pkief.material-icon-theme-4.34.0\\temp");
        File[] files = file.listFiles();
        assert files != null;
        for (File f : files) {
            String fileName = f.getName();
            String outputIconPath = "D:\\Java Learning\\Samples\\FileExplorer\\src\\icons\\fileIcons\\" + fileName.substring(0, fileName.lastIndexOf(".")) + ".png";
