...
//        System.out.println(file.exists() ? "File exists" : "File not found");
        ...
        File file = new File("D:\\Learning Course\\svg\\temp");
        File[] files = file.listFiles();
        assert files != null;
        for (File f : files) {
            String fileName = f.getName();
            String outputIconPath = "D:\\Java Learning\\Samples\\FileExplorer\\src\\icons\\JMenuItem_Icons\\" + fileName.substring(0, fileName.lastIndexOf(".")) + ".png";
            convertSvgToIcon(f.getAbsolutePath(), outputIconPath, 25, 25);
        }
